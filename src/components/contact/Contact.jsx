          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">
                miguelferca@outlook.com
              </span>
              <a
                href="mailto:miguelferca@outlook.com"
            ...
            <div className="contact__card">
              ...
              <h3 className="contact__card-title">Messaging</h3>
              <span className="contact__card-data">miguelfernandezcampos</span>
              <a
